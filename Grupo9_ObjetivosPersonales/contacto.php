                    ...
                    <div class="col-lg-9">
                        ...
                        <form id="formContacto">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control rounded" placeholder="Nombre"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control rounded" placeholder="Apellido"
                                    aria-label="Username" aria-describedby="basic-addon1" required />
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="email" class="form-control rounded" placeholder="Email" aria-label="email"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea name="" cols="30" rows="10" placeholder="Consulta"
                                    class="form-control rounded" required></textarea>
                            </div>
